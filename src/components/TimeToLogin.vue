<template>
    ...
    <header>
        <a href="https://me.nextblu.com/">
            <img src="https://www.nextblu.com/img/favicon.png" alt="App logo"/>
        </a>
        <h1>NextBlu</h1>
    </header>
    ...
    <div class="profile-bio">
        <p>The lightning fast system to interact with NextBlu.</p>
        <br>
    </div>
